export const myQuestions = [
    {
        question: "What is Phyllis's maiden name?",
        answers: [
    ...
    },
    {
        ...
        answers: [
            { text: "MISSsterious", correct: true},
            { text: "MISStery", correct: false},
            { text: "Sassypants", correct: false}
        ]
    },
    {
    ...
    },
    {
        ...
        answers: [
            { text: "Foggy 901", correct: false},
            { text: "Dr. Ira Glass", correct: false},
            { text: "Froggy 101", correct: true}
        ]
    },
    {
        question: "What acronym does Creed come up with during his brief reign as manager?",
        answers: [
            { text: "NOBODDY", correct: false},
            { text: "BOBODDY", correct: true},
            { text: "DUNDER", correct: false}
        ]
    },
    {
